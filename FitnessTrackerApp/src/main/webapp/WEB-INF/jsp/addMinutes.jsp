		...
		function(){
			$.getJSON('<spring:url value="activities.json"/>',{
					ajax:'true'
						...
						var html = '<option value="">--Please select one value--</option>';
						var len = data.length;
						for(var i=0;i<len;i++){
...
<body>
	...
	<form:form commandName="exercise">
		<table>
			...
			<tr>
				<td colspan="3"><input type="submit" value="Enter exercise"></input></td>
			</tr>

		</table>
	</form:form>

	<h1>Goal set for today is ${goal.minutes}</h1>
</body>
</html>